...
| `editor/` | vscode-API helpers | Forced-cursor placement overrides the user setting for HTML/MD/non-stylesheet → stylesheet; Astro frontmatter constrains placement to within `---` fences but respects the user's Top/Bottom/Cursor setting |
