...
| `00-setup.md` | Pre-test: F5 the Extension Development Host, open `../manual-qa-workspace/` as a folder. Not numbered in the run sequence |
...
4. If the checklist needs new fixtures, add them to `../manual-qa-workspace/` *and* to that workspace's `README.md` "Maintenance notes" (renaming-protection).
