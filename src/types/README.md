...
| `import-type.ts` | `ImportType` | Four-way classifier: `'script' \| 'stylesheet' \| 'markdown' \| 'image'`. |
| `notification.ts` | `NotificationType` | Two-way warning kind: `'same-file-path' \| 'not-supported'`. |
