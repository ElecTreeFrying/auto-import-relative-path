...
| [`mdx/`](mdx/) | [`checklists/mdx.md`](../checklists/mdx.md) | 39 | `.mdx` destination — accept-all + two-script-arm + asset model (7 TS / 7 JS-fallback styles or fixed asset shapes), Angular-only smart identifiers, markdown-star `.mdx`≠`.tsx` quirk, placement, gating, DnD |
