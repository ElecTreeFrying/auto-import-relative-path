...
4. Walk [`checklists/00-setup.md`](checklists/00-setup.md) through [`checklists/21-paste-into-framework-components.md`](checklists/21-paste-into-framework-components.md) in order.
