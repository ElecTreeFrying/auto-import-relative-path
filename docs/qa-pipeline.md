...
*Distilled from the original design spec, now archived alongside the spent runbooks; the operator README carries the provenance pointer and remains the authoritative reference for running the pipeline.*
